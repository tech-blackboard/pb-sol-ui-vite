...
export default function ComposeEmailModal() {
    ...
    const { isComposeModalOpen } = useAppSelector((state: RootState) => state.crm);

    if (!isComposeModalOpen) return null;

    return (
        <div className="fixed inset-0 z-50 flex items-end justify-end sm:items-center sm:justify-center p-0 sm:p-4 bg-black/30 animate-in fade-in duration-200">
