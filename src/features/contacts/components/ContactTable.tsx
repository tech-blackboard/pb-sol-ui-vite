...
function ContactRow({ item, onView, onRestore, isSelected, hasSelections, onToggleSelect, hideCheckboxes }: ContactRowProps) {
    return (
...
interface Props {
    ...
    onRestore?: (item: ContactItem) => void;
    selectedIds?: number[];
...
export default function ContactTable({ rows, loading, onView, onRestore, selectedIds = [], onSelect, onSelectAll, hideCheckboxes = false }: Props) {
                ...
                <table className="min-w-full text-left text-sm border-collapse">
                    <thead className="bg-gray-50 text-gray-600 sticky top-0 z-10 border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-3 py-2 text-gray-700 font-semibold min-w-[12rem]">Website Name</th>
