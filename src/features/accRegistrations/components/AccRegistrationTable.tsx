                ...
                <table className="min-w-full text-left text-sm border-collapse">
                    <thead className="bg-gray-50 text-gray-600 sticky top-0 z-10 border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-4 py-3 font-semibold min-w-[8rem]">Accm</th>
                            <th className="px-4 py-3 font-semibold min-w-[8rem]">Acmpng</th>
                            <th className="px-4 py-3 font-semibold min-w-[8rem]">Acc_pr</th>
                            ...
                            <th className="px-4 py-3 font-semibold min-w-[10rem]">Alt_text</th>
                    ...
                    <tbody className="bg-white divide-y divide-gray-100">
                        ...
                        {!loading && error && (
                            <tr>
                                <td colSpan={24} className="px-4 py-10 text-center text-red-500">
                                    <div className="flex flex-col items-center gap-2">
                                        <span>{error}</span>
