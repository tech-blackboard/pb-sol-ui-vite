...
export default function RegistrationFiltersDrawer({ open, onClose }: Props) {
    const dispatch = useAppDispatch()
    const filters = useAppSelector((s) => s.registrations.draftFilters)
        ...
        <div className="fixed inset-0 z-50">
            ...
            <aside className="absolute right-0 top-0 h-full w-full max-w-md bg-white border-l shadow-xl flex flex-col">
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-800">
                    <h3 className="text-base font-semibold">Registration Filters</h3>
                ...
                <div className="flex-1 overflow-auto p-4 space-y-3">
                    ...
                    <Input
                        ...
                        onChange={(v) =>
                            dispatch(updateDraftFilter({ key: 'institution', value: v }))
                        }
                    />
                    ...
                    <Input
                        ...
                        onChange={(v) =>
                            dispatch(updateDraftFilter({ key: 'presentation', value: v }))
                        }
                    />
                    ...
                    <Input
                        ...
                        onChange={(v) =>
                            dispatch(updateDraftFilter({ key: 'status_flag', value: v }))
                        }
                    />
