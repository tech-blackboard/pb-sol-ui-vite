...
describe('SponsorshipForm', () => {
  ...
  it('successfully submits the form', async () => {
    ...
    fireEvent.change(
      screen.getByLabelText('Organization / Institution*'),
    ...
    fireEvent.change(
      screen.getByLabelText('Website / Conference*'),
      { target: { value: '1' } }
    )
  ...
  it('handles submission error', async () => {
    ...
    // ✅ LINT-SAFE fix (NO any)
    Object.defineProperty(createSponsorshipThunk, 'fulfilled', {
      value: { match: () => false },
    })
    ...
    fireEvent.change(
      screen.getByRole('combobox', { name: /website/i }),
      { target: { value: '1' } }
    )
